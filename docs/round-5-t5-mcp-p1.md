...
> 承接 Round 3 [§17.3](./round-3-execution-plan.md#173-决策是否增加-create_book--update_book) 的「若将来做」最小集；**本轮改为实施**。  
...
- [round-3-execution-plan.md §十七 / §17.3](./round-3-execution-plan.md#十七后续规划mcp-实测反馈与体验增强)  
