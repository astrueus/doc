...
> Round 1–2 ✅ · Round 3 MCP MVP ✅（搜索 → Round 5 T3）· §十七 P0 ✅ · Round 4 代码主线 ✅ · **Round 5 ⏳ 已规划未开工**。  
...
| [round-5-execution-plan.md](./round-5-execution-plan.md) | Round 5 · 搜索 / Vite / 工程化 / 分层债 | ⏳ 规划中 |
...
| Round 3 | MCP 10 工具 + HTTP Bearer | ✅ MVP | 搜索→R5 T3；P0 体验经 R4 T13 ✅ |
| Round 4 | 模型 / zap / i18n / 前端 P1 / Repo / 测试 | ✅ 主线 | 遗留移交 Round 5 |
| Round 5 | 搜索 / Vite / 工程化 / 分层债 | ⏳ | 见 [round-5](./round-5-execution-plan.md)；按需推进 |

**Round 4 已合入（`v2.2.1`）要点：** BookModel 拆分、`md_` 修复、zap、Session 只存 id、前端 P1、`internal/i18n`、Repository 初版、pkg 单测、MCP P0。  
**Round 5 承接：** FULLTEXT 搜索、Vite P2、缓存/ORM 报告、MCP P1、测试 CI、`*Result`→dto、Repo 扩面等。
