...
> Round 1–2 ✅ · Round 3 MCP MVP ✅ · §十七 P0 ✅ · Round 4 代码主线 ✅ · **Round 5 🔶**（批次 A/B 已合入，T12-a/b 缓存内核已落地；搜索 FULLTEXT ⏸）。  
...
| Round 5 | 工程化 / Vite / 对象存储 / kratos 向评估 | 🔶 | 见 [round-5](./round-5/)；T12-a/b 已落地；T3/T4/T13 ⏸ |
