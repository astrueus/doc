...
#### (5) `docs/release/release-local.md` 第 19 行
...
> `docs/release/release-local.md` 中其他 `static`、`views` 字样也需要同步排查替换。
...
#### (4) `docs/deploy-spug/deploy-spug-local.md` 和 `docs/deploy-spug/deploy-spug-actions.md`
...
- [ ] `docs/release/release-local.md` —— zip 打包内容、`scripts/build.sh` 路径
- [ ] `docs/release/release-gitea-actions.md` —— CI 构建路径
- [ ] `docs/deploy-spug/deploy-spug-local.md` —— spug 部署路径
- [ ] `docs/deploy-spug/deploy-spug-actions.md` —— spug actions 路径
- [ ] `docs/router/router-split-migration-plan.md` —— 若已做阶段 3，更新 `routers/` 为 `server/routers/`
- [ ] `docs/router/routers-reference.md` —— 同上
