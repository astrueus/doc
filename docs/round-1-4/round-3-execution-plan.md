...
| —   | MCP 体验增强（P0/P1）                  | P0: `c70d4c1`（R4 T13） | ✅ P0 / 📦 P1→R5 T5 | P0 已合入；**P1 已移交** [round-5 T5](../round-5/round-5-execution-plan.md#七t5--mcp-体验-p10.5~1-天) |
...
- [round-5-execution-plan.md](../round-5/round-5-execution-plan.md) — **P1 / FULLTEXT / 倒排等已移交至此**
...
> **落点：** P0 已由 Round 4 T13 收口。**P1 📦 已移交 [Round 5 T5](../round-5/round-5-execution-plan.md#七t5--mcp-体验-p10.5~1-天)**（不再挂 Round 4）。P2 与 Book 级工具默认延后；FULLTEXT 见 Round 5 T3。
...
> 下列项**不再**由 Round 3/4 排期；执行见 [round-5-execution-plan.md §七](../round-5/round-5-execution-plan.md#七t5--mcp-体验-p10.5~1-天)。
