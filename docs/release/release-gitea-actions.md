...
Actions 把 `doc_<version>_linux_amd64.tar.gz` 发布到 Gitea Release 后，Spug 拉取并部署到目标服务器。详见 [`deploy-spug-actions.md`](../deploy-spug/deploy-spug-actions.md)。包结构与 [`release-local.md`](./release-local.md) 一致。
