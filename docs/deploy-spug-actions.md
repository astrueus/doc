...
> 配合 [`release-gitea-actions.md`](./release-gitea-actions.md)。push tag 后 Actions 自动产出 Release 附件，Spug 拉取并部署。
...
| 项目 | 要求 | 参考 |
|------|------|------|
| Actions 发版链路 | 已可正常 push tag 出 Release | [release-gitea-actions.md](./release-gitea-actions.md) |
...
- [release-gitea-actions.md](./release-gitea-actions.md)：Actions workflow 详解
- [release-local.md](./release-local.md)：本地脚本发版（Runner 故障时备选）
