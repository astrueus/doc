# Round 6 · T6 · 前端 P2 Vite — 细化方案

> 对应 [round-6-execution-plan.md](./round-6-execution-plan.md)。  
> 底稿沿用 [round-4 §十 T9](../round-1-4/round-4-execution-plan.md#t9--p21~2-周)。  
> **不做：** Bootstrap 升级、Vue 3 SPA、Tailwind。  
> **状态：** ⏳ 待实施（已从 Round 5 划入；建议独立 sprint）。
...
- [round-4-execution-plan.md §十 T9](../round-1-4/round-4-execution-plan.md#t9--p21~2-周)  
