...
> **状态：** 📝 草案（2026-08-05）· **引擎选型未决** · **2026-09-01 划入 Round 6，未解冻前不处理**  
> **用途：** 取代 Round 3/5 原定的「MySQL FULLTEXT / SQLite FTS5 + 标题加权」路线；作为 [round-6-execution-plan.md](./round-6-execution-plan.md) T3 / T4 的**解冻前提文档**。  
...
- [ ] [round-6-execution-plan.md](./round-6-execution-plan.md) 将 T3/T4 改回可排期  
...
| 文档 | 关系 |
| --- | --- |
| [round-6-execution-plan.md](./round-6-execution-plan.md) | T3/T4 冻结与解冻条件 |
