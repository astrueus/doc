...
>
> **状态（2026-08-31 修订）：** 🔶 **批次 A + T5/T8/T9 已合入**；尾巴已收口（T7 云端 CI 绿）；**T12-a 内核已落地**。搜索 T3/T4 **持续冻结**。明细以 [§十四 追踪表](#十四追踪表) 为准。  
...
> **进度（2026-08-31）：** T12-a（Aside 内核 + 内存 Store + 击穿/负缓存/Soft-TTL 单测）已落地；T12-b/c/d 未做。
...
> 规划日：2026-08-03；**修订：2026-08-31 尾巴收口 + T12-a**。  
...
- [ ] 若动缓存：新前缀生效；压测击穿/穿透；指标可看；可回滚 `mode`（T12-a 仅内核，业务尚未切换）  
