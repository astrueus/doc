...
>
> **状态（2026-08-18 修订）：** 🔶 **批次 A 已合入 `master`**：T1/T2 评估收口、T15 脚本搬迁、T7 测试入口与 workflow。其余 ⏳。明细以 [§十四 追踪表](#十四追踪表) 为准。  
...
> 规划日：2026-08-03；**修订：2026-08-18 批次 A 合入**。  
> 批次 A **无独立 PR**（功能分支快进直推 `master`）。环境变量 `MINDOC_*`→`DOC_*` 不在 T 编号内，代码硬切为 `b7e7317`。
