...
- [ ] `docs/release-local.md` / `docs/deploy-spug-*.md` / `README.md` — 批量替换为 `make`/`just` 或权威路径  
...
4. 更新文档：[`docs/release-local.md`](./release-local.md)、[`docs/deploy-spug-local.md`](./deploy-spug-local.md)、根 [`README.md`](../README.md)、[`AGENTS.md`](../AGENTS.md) — 日常命令改为 `make`/`just`。  
