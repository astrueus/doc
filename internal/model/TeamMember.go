...
func (m *TeamMember) ChangeRoleId(teamId int, memberId int, roleId config.BookRole) (member *TeamMember, err error) {

	if teamId <= 0 || memberId <= 0 || roleId <= 0 || roleId > config.BookObserver {
